...
├── research-notes.md       ← Connectivity & flow characterization research
...
- **Rux Protocol Suite**  
  ruxvv (**Performance Edition**), ruxsv (**Stealth Edition**), ruxpv (**Survival Edition**)
...
- terminology related to **Challenging Connectivity Environments**  
...
- flow characterization studies  
- network measurement behavior  
...
- traffic pattern stability considerations  
- privacy guarantees  

Complements the main security model in `architecture/`.
...
- emerging trends in network operations  
